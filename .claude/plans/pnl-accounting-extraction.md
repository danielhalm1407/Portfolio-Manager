...
4. **kts.py smoke**: launch the app, connect, run a replay on the same symbol/window as `replay_state.json`, confirm the P&L panel and the P&L / positions / entry-vs-market plots ([_draw_pnl:3866](../../orders/kts.py#L3866), [_draw_positions:3898](../../orders/kts.py#L3898), [_draw_entry_vs_market:3948](../../orders/kts.py#L3948)) are unchanged, and scrub the replay slider to exercise `restore`.
